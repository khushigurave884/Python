# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 09:23:04 2024

@author: sai
"""

#1.Write a Python function that takes two lists and returns True if they have at least one commonmember.
...
#3.write a python program to revers a string
...
#5
"""Using dict comprehension and a conditional argument create a dictionary 
from the current dictionarywhere only the key:value pairs with 
value above 2000 are taken to the new dictionary."""
